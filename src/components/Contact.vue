...
export default {
  ...
  data() {
    return {
      activeTab: 'domestic', // Tab mặc định là "Thành phố thường nước"
    };
  },
};
</script>
        ...
        <div class="container">
          <div class="row">
            ...
            <main class="content">
              ...
              <h2 class="content-title">Liên hệ với Easy Booking</h2>
  
              <h4 class="section-title">Thông tin liên hệ</h4>
              <p class="section-text">
                <strong>Email:</strong> support@easybooking.com<br />
                <strong>Hotline:</strong> +84 986 386 984<br />
                <strong>Điện thoại cố định:</strong> 0986 386 984
              </p>
  
              <h4 class="section-title">Địa chỉ công ty</h4>
              <p class="section-text">
                Hoa Lac Hi-tech Park, km 29, Đại lộ, Thăng Long, Hà Nội, Vietnam
              </p>
            
  
              <h4 class="section-title">Thời gian làm việc</h4>
              <p class="section-text">
              ...
              <!-- Iframe Google Map -->
              <h4 class="section-title">Bản đồ</h4>
              <div class="map-container">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.5063419425264!2d105.52271427603011!3d21.012416680632743!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135abc60e7d3f19%3A0x2be9d7d0b5abcbf4!2sFPT%20University!5e0!3m2!1sen!2s!4v1743173464207!5m2!1sen!2s"
                  width="1000"
                  height="600"
                  style="border:0;"
                  allowfullscreen=""
              ...
              <!-- Phần hiện tại: Phố biến với du khách từ Việt Nam -->
              <section class="popular-section">
                ...
                <div class="additional-info">
                  <p>
                    Các quốc gia - Khu vực - Thành phố - Quận - Sân bay - Khách sạn - Địa điểm được quan tâm - Các Nhà Nghỉ Duống - Căn hộ - Các Resort - Các biệt thự - Các hostel - Nhà nghỉ B&B - Các nhà khách - Nhứng chỗ nghỉ độc đáo - Tất cả các điểm đến - Tất cả các điểm đến có chuyển bay - Tất cả địa điểm cho thuê xe - Tất cả điểm đến cho kỹ nghỉ - Hướng dẫn - Khám phá - Đánh giá của Khách - Khám phá lưu trú theo tháng
                  </p>
                </div>
